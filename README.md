...
|-----|-----|----------------|-------------|
| Empty content blocks | `fix-empty-content` | [#167](https://github.com/aws-samples/bedrock-access-gateway/issues/167) | Bedrock rejects empty content arrays that some OpenAI clients send. This skips them. |
